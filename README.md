...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/conftrak-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14864&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/conftrak-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `conftrak` can be installed with:

```
conda install conftrak
```

It is possible to list all of the versions of `conftrak` available on your platform with:
